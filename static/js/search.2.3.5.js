...
window.onload = function () {
  ...
  // Hugo's build process, with the template content\busqueda\search-index.md
  ...
  request.open("GET", "/busqueda/index.json", true); // Request the JSON file created during build
